...
public class ER_DodgeState : DodgeState
{
    ...
    public ER_DodgeState(Entity entity, BaseStateMachine stateMachine, string animBoolName, D_DodgeState stateData, EnemyRange enemy) : base(entity, stateMachine, animBoolName, stateData)
    {
        this.enemy = enemy;
    }
